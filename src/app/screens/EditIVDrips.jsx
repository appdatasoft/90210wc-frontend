...
export default class EditIVDrips extends React.Component {
    state = {
        data: [],
        edit: false,
        title: "",
    ...
    newEditedValue = () => {
        axios({
            method: 'put',
            url: 'http://localhost:4040/ivdrips/update',
    ...
    deleteData = (id) => {
        const url = `http://localhost:4040/ivdrips/delete/${id}`;
